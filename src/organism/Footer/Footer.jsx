        ...
        <div className="container pt-5">
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    ...
                    <p className="mb-2"><i className="bi bi-geo-alt text-primary me-2"></i>123 Street, Gurgaon, India</p>
                    <p className="mb-2"><i className="bi bi-envelope-open text-primary me-2"></i>ershubhamgupta1@gmail.com</p>
                    <p className="mb-0"><i className="bi bi-telephone text-primary me-2"></i>919050149160</p>
                </div>
                <div className="col-lg-3 col-md-6">
        ...
        <div className="container">
            <div className="row g-5">
                ...
                <div className="col-md-6 text-center text-md-end">
                    <p className="mb-0">Designed by <a className="text-white" href="https://htmlcodex.com">Shubham Gupta</a></p>
                </div>
            </div>
        </div>
    </div>
